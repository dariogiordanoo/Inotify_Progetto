...
main: main.o funzioni_cartella_file.o funzioni_cartella.o funzioni_file.o funzioni_inotify.o 
		gcc -o main main.o funzioni_cartella_file.o funzioni_cartella.o funzioni_file.o funzioni_inotify.o

main.o: main.c funzioni_cartella_file.h funzioni_cartella.h funzioni_file.h funzioni_inotify.h		
